...
built, fixed, and deferred. See [`CONTRIBUTING.md`](CONTRIBUTING.md) for
this project's development conventions (testing philosophy, data
provenance discipline, code style).
